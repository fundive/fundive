...
-- (events.enters_water, 20260925100000). Runs after the other seeds on every
...
-- diving, because the migration deliberately refuses to guess an event's
-- answer. Here we are the shop, so we can say.
