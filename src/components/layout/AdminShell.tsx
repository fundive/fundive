...
export function AdminShell() {
  ...
  // with the queue it links to — which is exactly what had happened here: this
  // badge still required `application_submitted_at is not null` long after
  // AdminApplicationsPage dropped that condition, so a diver who signed up and
  // stopped short of completing their profile sat on the queue and off the
  // badge. countOnHoldAccounts() is now the one definition both read.
  useEffect(() => {
