...
// a later catalog price change cannot retroactively rewrite what a season
...
export interface RevenueEvent {
  ...
  /** Catalog base price per head, resolved from the linked prices row. Used
 ...
 * snapshot, or the event's catalog price when the booking predates
