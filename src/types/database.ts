...
export interface Database {
  public: {
    Functions: {
      ...
      // Defined in 20260701020000_set_event_relations_rpc.sql, widened with
 ...
 * (20260823000000). The two "money returned" values are the ones that block a
...
export type CreditSource =
   ...
   *  `credits_amount_check` / `credits_charge_untied` (20260824030000). */
  | 'admin_charge'
