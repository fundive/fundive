...
| `dive_travel` | catalog | Transport options surface in the booking form. Bubble-imported, renamed + cleaned. |
...
The **reference tables** (`prices`, `rooms`, `addons`, `dive_travel`,
